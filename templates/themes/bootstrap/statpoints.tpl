...
<input type="submit" class="btn" name="stat" value="Strength" />
</form>
...
<form method="post" action="index.php?mod=StatPoints">
<input type="submit" class="btn" name="stat" value="Vitality" />
</form>
...
<form method="post" action="index.php?mod=StatPoints">
<input type="submit" class="btn" name="stat" value="Agility" />
</form>
...
<form method="post" action="index.php?mod=StatPoints">
<input type="submit" class="btn" name="stat" value="Dexterity" />
</form>
